...
<html>
    ...
    <h1 align='center' border='3' style="text-decoration: underline;"><br> Login Marque:</h1>
        ...
        font-size: 18px;
        color: #dc2743;" method="post" action="connexion_marque.php">
            <div id="div1" class="divininf">
                ...
                <div class="cnx"><a style="color: #dc2743;" href="signup_marque.php">S'inscrire</a></div>
            </div>
        </form>
    </body>
</html>