        ...
        if(!empty($userNewName) && !empty($userNewEmail)){
            ...
            //         $uploaded = move_uploaded_file($fileTmpName,$fileNewName);
                    ...
                    // if($uploaded){
                        ...
                        // var_dump ($conn);
                        if( $conn){
                            $sql1 = "UPDATE `influenceur` SET `nom`=' $userNewName',`email`='$userNewEmail' WHERE `id`='$loggedInUser'";
                            $results = mysqli_query($conn,$sql1);
                          header('Location: userinfluenceur.php?success=userUpdated');
                        }else{
                ...
                header('Location: userinfluenceur.php?error=invalidFileType');
                exit;
            }
            ...
            header('Location: userinfluenceur.php?error=emptyNameAndEmail');
            exit;
        }
