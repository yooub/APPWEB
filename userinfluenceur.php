    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 offset-3">
                ...
                ?>
                <form action="userupdateinfluenceur.php"
                      method="POST"
                ...
                >
                    <?php
                        ...
                        $sql = "SELECT * FROM influenceur WHERE id = $inf_id ";
                        ...
                        if($gotResuslts){
                            if(mysqli_num_rows($gotResuslts)>0){
                                while($row = mysqli_fetch_array($gotResuslts)){
                                    ...
                                    ?>
                                        <div class="input">
                                            <input type="text" name="updateUserName" class="input-field" value="<?php echo $row['nom']; ?>">
